...
RSpec.describe BatchedRemoveStatusService, type: :service do
  ...
  let(:status1) { PostStatusService.new.call(alice, text: "Hello @bob@example.com", visibility: :public) }
  let(:status2) { PostStatusService.new.call(alice, text: "Another status", visibility: :public) }
