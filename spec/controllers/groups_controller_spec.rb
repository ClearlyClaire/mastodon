  ...
  describe 'GET #show' do
    ...
    context 'as HTML' do
      ...
      context do
        ...
        it 'does not render an unrelated status' do
          expect(response.body).to_not include(ActivityPub::TagManager.instance.url_for(unrelated_status))
        end

        it 'does not render an unapproved status' do
          expect(response.body).to_not include(ActivityPub::TagManager.instance.url_for(unapproved_status))
        end
      end
      ...
      context 'when signed-in' do
        ...
        context 'when user is blocked' do
          before do
            group.account_blocks.create!(account: user.account)
            get :show, params: { id: group.id, format: format }
          end
